...
public class MyTree
{
	...
	{	
        ...
        nodeImages.add("所有在线用户"+MyTools.SPLIT1+"../img/背景.png"+MyTools.SPLIT1+"../img/背景.png");
        nodeImages.add("所有不在线用户"+MyTools.SPLIT1+"../img/背景.png"+MyTools.SPLIT1+"../img/背景.png");
      // nodeImages.add("黑名单111"+MyTools.SPLIT1+"../img/face/f035.png"+MyTools.SPLIT1+"../img/背景.png");
        
        nodeImages.add("我的好友"+MyTools.SPLIT1+"../img/face/背景.png"+MyTools.SPLIT1+"../img/face/背景.png");        
